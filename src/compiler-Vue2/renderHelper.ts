 ...
 */
export default function renderHelper(target:any) {
 ...
 */
function createElement(tag:string, attr:any, children:any) {
  return VNode(tag, attr, children, this, null)
}
 ...
 */
function createTextNode(textAst:AST) {
 ...
 */
function renderSlot(attrs:any, children:any) {
  // 父组件 VNode 的 attr 信息
 ...
 * @returns vnode 数组
 */
function genVNode(childs:any, vm:any):any {
  const vnode = []
